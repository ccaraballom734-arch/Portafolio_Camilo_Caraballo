      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 p-6 sm:p-8">
          ...
          <div className="md:col-span-6 space-y-4">
            <div className="relative rounded-2xl overflow-hidden aspect-video shadow-md border border-slate-200/50">
              <img
              ...
              />
              <div className="absolute top-3 left-3 bg-blue-600 text-white text-xs font-semibold px-2.5 py-1 rounded-md">
                {project.category}
              </div>
            </div>
